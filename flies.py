...
for i in range(0, 60): 
pygame.image.save(screen, "./simonaEvtimova/" + str(frame_num) + ".png") frame_num = frame_num + 1 
clock.tick(60) 
...
self.bodyLocationY = self.headLocationY + (4 * 60) self.bodySize = (4 * 150) 
self.buttLocationX = self.bodyLocationX - (4 * 30) self.buttLocationY = self.bodyLocationY - (4 * 30) self.buttWidth = (4 * 60)
...
self.rightWingLocationX = self.bodyLocationX - (4 * 75) self.rightWingLocationY = self.bodyLocationY 
...
self.leftWingLocationX = self.bodyLocationX - (4 * 160) self.leftWingLocationY = self.bodyLocationY - (4 * 20) self.leftWingWidth = (4 * 150) 
self.leftWingHeight = (4 * 75) 
self.rightWingLocationX = self.bodyLocationX + (4 * 10) self.rightWingLocationY = self.bodyLocationY - (4 * 20) self.rightWingWidth = (4 * 150) 
...
(self.buttLocationX, self.buttLocationY, self.buttWidth, self.buttHeight), 0) self.bug1_left_wing = pygame.draw.ellipse(screen, self.bugColor, 
...
self.bug2_butt = pygame.draw.ellipse(screen, self.bugColor, (self.buttLocationX + (width/3), self.buttLocationY, self.buttWidth, self.buttHeight), 0) self.bug2_left_wing = pygame.draw.ellipse(screen, self.bugColor, 
...
self.bug3_butt = pygame.draw.ellipse(screen, self.bugColor, (self.buttLocationX - (width/3), self.buttLocationY, self.buttWidth, self.buttHeight), 0) self.bug3_left_wing = pygame.draw.ellipse(screen, self.bugColor, 
(self.leftWingLocationX - (width/3), self.leftWingLocationY, self.leftWingWidth, self.leftWingHeight), 0)
